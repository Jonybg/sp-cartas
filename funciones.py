...
def transferir_cartas(ganador, carta1, carta2, mazo_jugadores, datos_jugadores):
    ...
    print(f"{datos_jugadores[ganador]['nombre']
             } gana la ronda y recibe las cartas")
...
def ganador_ronda(resultado, carta1, carta2, datos_jugadores, mazo_jugadores, pilon_mesa, victorias_elemento, atributo_elegido):
    if resultado == "Empate":
        agregar_a_mesa(pilon_mesa, carta1, carta2)
        return victorias_elemento
    # dos returns
    ...
    incrementar_victorias_elementales(
        atributo_elegido, ganador, victorias_elemento)
    return ganador, victorias_elemento
# tres returns
...
def determinar_ganador_final(datos_jugadores: dict, mazo_jugadores: dict, victorias_elementos) -> None:
    ...
    if victorias_elementos["jugador1"] >= 10:
        print(f"\n{datos_jugadores['jugador1']['nombre']} gana el juego con {
              victorias_elementos['jugador1']} victorias elementales!")
    elif victorias_elementos["jugador2"] >= 10:
        print(f"\n{datos_jugadores['jugador2']['nombre']} gana el juego con {
              victorias_elementos['jugador2']} victorias elementales!")
