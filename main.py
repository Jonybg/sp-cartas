...
def jugar_partida():
    ...
    while rondas <= max_rondas:
        ...
        ganador_ronda(resultado, carta1, carta2,datos_jugadores, mazo_jugadores, mesas, empate, victorias_elementos, atributo_elegido)
        
        if victorias_elementos["jugador1"] >= 10:
            print(f"{datos_jugadores['jugador1']['nombre']} es el ganador por alcanzar 10 victorias elementales.")
            ...
            print(f"{datos_jugadores['jugador2']['nombre']} es el ganador por alcanzar 10 victorias elementales.")
            #print(f"{datos_jugadores['jugador1']['nombre']} tiene {len(mazo_jugadores['jugador1'])} cartas.")
            #print(f"{datos_jugadores['jugador2']['nombre']} tiene {len(mazo_jugadores['jugador2'])} cartas.")
            break
        ...
        determinar_ganador_final(datos_jugadores, mazo_jugadores, victorias_elementos)
